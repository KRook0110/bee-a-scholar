  ...
  return (
    <div className="poppins">
      ...
      <main className="flex flex-col gap-32">
        ...
        {/* Jumbotron */}
        <section className={`flex flex-row items-center justify-center w-full raleway px-[5%]`}
          style={{
              position: "relative",
              width: "100%",
              height: "100vh",
        ...
        {/* Welcome */}
        <section className="flex flex-col sm:flex-row columns-2 items-center w-full raleway px-[10%]">
        ...
        {/* Why Choose Us */}
        <section className="flex flex-col items-center justify-center raleway gap-5 px-[5%]">
          ...
          <div className="flex flex-col sm:flex-row columns-3 pt-5 px-24 mx-10 gap-16 text-center">
              <div className="w-1/3 flex flex-col items-center justify-start pt-5">
                  ...
                  <h3 className="font-display font-[600] text-[24px] text-[#1C429A]">
                    Sophisticated Filtering
                  </h3>

                  <p className="font-display text-center text-sm text-black">
        ...
        {/* Partners */}
        <section className="flex flex-col-reverse md:flex-row columns-2 items-center justify-center raleway gap-10 px-[5%]">
          ...
          <div className="flex flex-col w-full gap-10 pr-20">
              <div className="flex flex-row space-x-2 items-center gap-5">
                  <img className='w-10' src="icons/honey.png" alt="" />
                  <h3 className="text-[34px] font-display font-semibold">Our partners</h3>
              </div>
              ...
              <p className="font-display text-black leading-[20px]">
                ...
                <span className="font-semibold text-[#1C429A]">Together, we're opening doors to brighter futures.</span>
              </p>
          </div>
        </section>
